...
<<<<<<< HEAD
python3 ImageInpainting.py --input ./dataset/data9/image-4.png --mask ./dataset/data9/mask-4.png --output ./result/result9.png --patch_size 5
=======
...
>>>>>>> b0ec008 (Change normal_direction method)
